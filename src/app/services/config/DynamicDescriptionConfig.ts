...
import { BidiMap, Configuration } from '../DynamicGUIService';
import { LFService, LoggerFactoryOptions, LogLevel, LogGroupRule, LoggerFactory, Logger } from 'typescript-logging';

export class DynamicDescriptionConfig implements DescriptionConfig {
    ...
    public getElementConfig(model: any, fieldName: string, configType: string, formField?: string): any {
    ...
    public getConfigFor(name: string): DescriptionConfig {
        ...
        return new DynamicDescriptionConfig(value, this._elementConfig, this._profileIDMap, this.dynamicGUI);
    }
